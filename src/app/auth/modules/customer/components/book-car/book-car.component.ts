...
export class BookCarComponent {
  ...
  bookCar(formData: any) {
    ...
    let obj = {
      fromDate: new Date(formData.fromDate).getTime(), // Convertir en timestamp Unix en millisecondes
      toDate: new Date(formData.toDate).getTime(),     // Convertir en timestamp Unix en millisecondes
